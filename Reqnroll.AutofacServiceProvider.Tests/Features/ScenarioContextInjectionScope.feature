Feature: ScenarioContextInjectionScope
    Issue #12: Scoping Context Injection to Scenario Execution Lifetimes
    https://github.com/solidtoken/Reqnroll.DependencyInjection/issues/12

@ScenarioRegistration
Scenario: Assert a Scenario Context Is Scoped To Scenario Execution
...
@ScenarioRegistration
Scenario: Assert a Scenario Context Is Scoped To Scenario Execution (No Spill)

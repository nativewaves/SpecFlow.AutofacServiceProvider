...
using NativeWaves.Reqnroll.AutofacServiceProvider;
using System;
...
namespace NativeWaves.Reqnroll.AutofacServiceProvider
{
    public class AutofacServiceProviderPlugin : IRuntimePlugin
    {
        ...
        private static readonly ConcurrentDictionary<IReqnrollContext, ILifetimeScope> ActiveServiceScopes = new ConcurrentDictionary<IReqnrollContext, ILifetimeScope>();
        ...
        private static void RegisterProxyBindings(IObjectContainer objectContainer, IServiceCollection services)
        {
            ...
            // Bases on this: https://docs.Reqnroll.org/projects/Reqnroll/en/latest/Extend/Available-Containers-%26-Registrations.html
